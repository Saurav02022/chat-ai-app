    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="text-center space-y-4">
          ...
          >
            <DialogTitle className="text-2xl font-bold">
              Welcome to JobCraft AI
            </DialogTitle>
            <DialogDescription className="text-base text-muted-foreground">
              Get started with AI-powered job search tools
            </DialogDescription>
          </motion.div>
        </DialogHeader>
        ...
        >
          ...
          {/* Simple benefits - just key points */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <p className="text-sm text-muted-foreground">
              Free resume optimization • AI interview coaching • ATS-ready
              templates
            </p>
          </motion.div>
        </motion.div>
        ...
        <motion.div
          ...
          className="text-xs text-center text-muted-foreground mt-6 leading-relaxed"
        >
